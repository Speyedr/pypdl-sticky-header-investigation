...
class Pypdl:
    ...
    def stop(self) -> None:
        ...
        self._stop = True
        time.sleep(1)
        self.logger.debug("Download stopped")    # logger typo here

    def shutdown(self) -> None:
        """Shutdown the download manager."""
        self._pool.shutdown()
        self.logger.debug("Shutdown download manager")   # logger typo (manger -> manager)
    ...
    def _reset(self):
        ...
        self.completed = False
        self.wait = True
        self.logger.debug("Reset download manager")   # another logger typo here
